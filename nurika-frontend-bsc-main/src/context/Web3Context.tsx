...
import { BASE_CHAINS_LIST, BASE_CHAIN_CONFIG, BASE_CHAIN_CURRENCIES, CHAIN_ID } from "../constants/network";
  ...
  const switchWalletChain = async () => {
    if (walletProvider) {
      ...
      try {
        ...
        console.log("IN hererer::: ", BASE_CHAIN_CONFIG[CHAIN_ID], CHAIN_ID, BASE_CHAINS_LIST)
              ...
              await ethersProvider.send("wallet_addEthereumChain", [
                {
                    ...
                    nativeCurrency: {
                      ...
                      symbol: BASE_CHAIN_CURRENCIES[CHAIN_ID].symbol, // 2-6 characters long
                      decimals: 18,
                    },
